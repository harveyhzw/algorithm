...
class BinaryTreeTraversal {
     ...
     * 递归先序遍历
     */
    public static void preOrderRec(BTreeNode root){
        if(root!=null){
     ...
     * 递归中序遍历
     */
    public static void inOrderRec(BTreeNode root){
        if(root!=null){
            preOrderRec(root.left);
            System.out.println(root.value);
            preOrderRec(root.right);
     ...
     * 递归后序遍历
     */
    public static void postOrderRec(BTreeNode root){
        if(root!=null){
            preOrderRec(root.left);
            preOrderRec(root.right);
            System.out.println(root.value);
     ...
     */
    public static void preOrderStack_1(BTreeNode root){
        if(root==null)return;
     ...
     */
    public static void preOrderStack_2(BTreeNode root){
        if(root==null)return;
        Stack<BTreeNode> s=new Stack<BTreeNode>();
     ...
     */
    public static void inOrderStack(BTreeNode root){
        if(root==null)return;
        Stack<BTreeNode> s=new Stack<BTreeNode>();
        while(root!=null||!s.isEmpty()){
            while(root!=null){
     ...
     */
    public static void postOrderStack(BTreeNode root){
        if(root==null)return;
        Stack<BTreeNode> s=new Stack<BTreeNode>();
        Map<BTreeNode,Boolean> map=new HashMap<BTreeNode,Boolean>();
        s.push(root);
        while(!s.isEmpty()){
            BTreeNode temp=s.peek();
     ...
     */
    public static void levelTravel(BTreeNode root){
        if(root==null) return;
